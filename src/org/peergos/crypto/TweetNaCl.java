...
public class TweetNaCl {
    ...
    private static long dl64(byte[] x, int xOff)
    {
        long u=0;
    ...
    private static int crypto_hashblocks(byte[] x,byte[] m, int n)
    {
    ...
    private static int crypto_hash(byte[] out,byte[] m,int mOff, int n)
    {
